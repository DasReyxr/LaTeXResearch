...
\section{Suma}
\begin{frame}{Suma}
    \begin{block}{Algoritmo de la suma}
        El algoritmo de la suma es uno de los fundamentos básicos. Consiste en tomar dos objetos \textbf{del mismo tipo} y combinarlos para obtener un resultado que representa la adición de ambos, además el algoritmo \textbf{esta sujeto} a las reglas de la aritmética del tipo de objeto que se está sumando 
    \end{block}
    \begin{alertblock}{Ejemplo}
        Sumar dos números enteros: $5 + 3 = 8$.

        Sumar dos vectores: $\begin{bmatrix}1 \\ 2\end{bmatrix} + \begin{bmatrix}3 \\ 4\end{bmatrix} = \begin{bmatrix}4 \\ 6\end{bmatrix}$.

        Sumar dos bits: $1 + 1 = 10$.
    \end{alertblock}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\linewidth]{src/BT8.png}
\end{figure}
