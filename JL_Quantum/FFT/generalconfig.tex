...
\usepackage{xcolor}
\usepackage{parskip}
% \usepackage[backend=biber,style=apa]{biblatex} % Commented: conflicts with numeric citations
% \addbibresource{references.bib} % Commented: using manual thebibliography instead
\usepackage[numbers]{natbib} % For numeric [1] style citations
\usepackage{hyperref}
\usepackage{fontawesome5} % For the GitHub icon
\usepackage[justification=centering]{caption}
% \usepackage[linesnumbered,ruled,vlined]{algorithm2e} % Conflicts with algorithm/algorithmicx
...
\usepackage{listings}
\usepackage{xcolor}
\newcommand{\frt}[1]{\tilde{f}\left\{#1\right\}}
\newcommand{\frtn}[1]{f\left\{#1\right\}}
