...
\begin{document}
    ...
    \fmSubSec{RLC}
    \subsubsection*{DC}
    \includegraphics[width=0.8\linewidth]{src/FM4/LC Behavioral.png}
    \begin{itemform}
    ...
    \right.
    $$
%    \includegraphics[width=0.3\textwidth]{src/FM4/image.png}
    \end{itemform}
    \subsection*{AC}
    \begin{itemform}
    \item RL
...
\begin{multicols}{2}
    ...
    \begin{center}
        \includegraphics[width=0.55\linewidth]{src/FM4/TrianglePower.png}
    \end{center}
...
\begin{multicols}{2}
    ...
    \begin{itemform}
        \item 
        $$|Z_{SC}|=\dfrac{V_{SC}}{I_{SC}}\quad Z_{SC}=R_{eq}+jX_{eq}$$
        \item 
    ...
    \begin{itemform}
        \item Corrientes
        $$I_{rated}=\dfrac{S_{rated}}{V_{rated}} \quad I_{fl}= I_{rated} \angle \arccos(P.F.)$$
        \item Voltajes
        ...
        $$P_o = V_s I_{rated} PF$$
    \end{itemform}
    \textbf{AutoTransformador}

    \includegraphics[width=0.7\linewidth]{src/FM4/AutoTransformador.png}
    
    \begin{itemform}
        \item Identificacion parametros $1000 KVA\ 12/1.2KV$
        $$ S_{w} = 1000 KVA \quad NSE = 12 KV \quad NC = 1.2 KV$$
        \item Potencia de salida
        $$S_{io}=V_H \dfrac{S_w}{N_C}; V_H = V_{SE} + V_{C}$$
        \item Relacion de Potencia
        $$\dfrac{S_{io}}{S_w}= \dfrac{N_{SE}+N_C}{N_C}$$
    \end{itemform}
...
\end{description}
\end{multicols}
\includegraphics[width=1\linewidth]{src/FM4/Comparador.png}

\newpage
\section{Electronica de Potencia}
\begin{multicols}{2}
\fmSubSec{Convertidores CC}
\includegraphics[width=0.9\linewidth]{src/FM4/BuckBoost.png}
\textbf{Buck}
\begin{itemform}
    \item Vo
    $$V_o = d\,V_i $$
...
\end{itemform}
\includegraphics[width=1.3\linewidth]{src/FM4/Amp.png}
\end{multicols}
\newpage
...
\begin{multicols}{2}
    ...
    \end{itemform}
    \includegraphics[width=0.9\linewidth]{src/FM4/RectaExcursion.png}
    
    \subsubsection*{AC Analysis}

    \includegraphics[width=\linewidth]{src/FM4/ModelosIII.png}
%    \includegraphics[width=0.9\linewidth]{src/FM4/Modelos.png}
    ...
    \end{itemform}
        \includegraphics[width=0.8\linewidth]{src/FM4/Fets.png}

    \fmSubSec{FETS}
        \includegraphics[width=0.8\linewidth]{src/FM4/FETSyMoSFET.png}
...
\end{multicols}
\includepdf[pages=-, pagecommand={}]{src/FM4/FETConf.pdf}
\includepdf[pages=-, pagecommand={}]{src/FM4/BJTConf.pdf}
\newpage
...
$$
    \includegraphics[width=0.7\linewidth]{src/FM4/Colpits.png}
...
$$
    ...
    \includegraphics[width=0.5\linewidth]{src/FM4/Oscilator.png}
    \subsubsection*{AC Analysis}
%    \includegraphics[width=0.9\linewidth]{src/FM4/Modelos.png}
